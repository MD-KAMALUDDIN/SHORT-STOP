...
android {
    ...
    defaultConfig {
        ...
        // Guarantee 64-bit support — required by Play Store.
        // arm64-v8a  : all modern Android devices
        // x86_64     : emulators and ChromeOS
        // armeabi-v7a: 32-bit fallback for older devices (minSdk 26 still sees these)
        ndk {
